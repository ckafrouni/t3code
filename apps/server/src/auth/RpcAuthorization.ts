...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.workspaceExportPrepare]: AuthOrchestrationReadScope,
  [WS_METHODS.workspaceUploadPrepare]: AuthOrchestrationOperateScope,
  [WS_METHODS.workspaceUploadRefresh]: AuthOrchestrationOperateScope,
  ...
  [WS_METHODS.previewForwardPort]: AuthTerminalOperateScope,
  [WS_METHODS.previewForwardedPorts]: AuthOrchestrationReadScope,
